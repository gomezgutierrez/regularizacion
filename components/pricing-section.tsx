            ...
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-200 max-w-4xl mx-auto flex flex-col md:flex-row">
                    ...
                    <div className="p-8 md:p-12 md:w-3/5 flex flex-col justify-center">
                        ...
                        <p className="text-accent font-bold mb-6">Paso 1: Análisis Personalizado</p>

                        <ul className="space-y-4 mb-8">
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                                <span className="text-slate-600">Análisis exhaustivo de tu documentación</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                                <span className="text-slate-600">Verificación de requisitos Reforma 2026</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                                <span className="text-slate-600">Informe de viabilidad por Abogada ICAV 14318</span>
                            </li>
                            <li className="flex items-start">
                                <Check className="w-5 h-5 text-green-500 mr-3 flex-shrink-0 mt-0.5" />
                                <span className="text-slate-600">Hoja de ruta clara para tu regularización</span>
                            </li>
                        </ul>
